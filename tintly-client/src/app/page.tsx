      ...
      <header className="border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">Theme Generator</span>
          </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setTheme(prev => prev ? { ...prev, description: e.target.value } : prev)}
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <ColorPicker
                    ...
                    onChange={(value) => updateThemeColor('primary.foreground', value)}
                  />
                  <ColorPicker
                    label="Secondary Color"
                    value={theme.colors.secondary[500]}
                    onChange={(value) => updateThemeColor('secondary.500', value)}
                  />
                  <ColorPicker
                    label="Secondary Foreground"
                    value={theme.colors.secondary.foreground}
                    onChange={(value) => updateThemeColor('secondary.foreground', value)}
                  />
                  <ColorPicker
                    label="Accent Color"
